...
TENANT_NOT_ENROLLED.message =
  'Your company is not enrolled in Did. Please contact did@puzzlepart.com.'
TENANT_NOT_ENROLLED.status = 401

const USER_NOT_ENROLLED = new Error()
USER_NOT_ENROLLED.name = 'USER_NOT_ENROLLED'
USER_NOT_ENROLLED.message =
  "It seems you're not enrolled in Did. Please contact your system owner."
