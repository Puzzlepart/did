...
Defined in: [server/services/oauth.ts:18](https://github.com/Puzzlepart/did/blob/63fb8902/server/services/oauth.ts#L18)
...
Defined in: [server/services/oauth.ts:26](https://github.com/Puzzlepart/did/blob/63fb8902/server/services/oauth.ts#L26)
...
Defined in: [server/services/oauth.ts:47](https://github.com/Puzzlepart/did/blob/63fb8902/server/services/oauth.ts#L47)
