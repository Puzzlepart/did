[did-server](../README.md) / [Modules](../modules.md) / utils/stripHtmlString
...
Defined in: [server/utils/stripHtmlString.ts:10](https://github.com/Puzzlepart/did/blob/a33ee165/server/utils/stripHtmlString.ts#L10)
