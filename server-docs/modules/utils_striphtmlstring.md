[did](../README.md) / utils/stripHtmlString
...
Defined in: [server/utils/stripHtmlString.ts:10](https://github.com/Puzzlepart/did/blob/50d5d352/server/utils/stripHtmlString.ts#L10)
