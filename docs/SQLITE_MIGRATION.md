...
| `REPORT_PRELOAD_L1_TTL_SECONDS` | In-process preload snapshot cache TTL (seconds) | `15` |
| `REPORT_PRELOAD_L1_MAX_ENTRIES` | Max in-process preload snapshot cache entries | `500` |
| `REPORT_PRELOAD_L2_TTL_SECONDS` | Redis preload snapshot cache TTL (seconds) | `120` |
