...
export const Logo: ReusableComponent<ILogoProps> = (props) => {
  return (
    <div className={Logo.className} aria-label='Logo'>
          ...
          <defs>
            <linearGradient id='lingrad' x1='0%' y1='0%' x2='100%' y2='100%'>
              ...
              <stop offset='75%' stopColor='#23a6d5'>
                <animate
                  attributeName='stop-color'
                  values='#23a6d5;#23d5ab;#ee7752;#e73c7e;#23a6d5'
                  dur='10s'
                  repeatCount='indefinite'
                />
              </stop>
              <stop offset='100%' stopColor='#23d5ab'>
                <animate
                  attributeName='stop-color'
                  values='#23d5ab;#ee7752;#e73c7e;#23a6d5;#23d5ab'
                  dur='10s'
                  repeatCount='indefinite'
                />
              </stop>
      ...
      {props.showMotto && (
        <Caption1 className={styles.motto}>
          <b>{packageFile.name}</b> - <i>{packageFile.description}</i>
        </Caption1>
      )}
      {props.showVersion && (
