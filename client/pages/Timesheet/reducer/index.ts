...
import { CHANGE_PERIOD, CHANGE_VIEW, CLEAR_IGNORES, CLEAR_MANUAL_MATCH, DATA_UPDATED, IGNORE_EVENT, MANUAL_MATCH, SET_SCOPE, SUBMITTING_PERIOD, TOGGLE_SHORTCUTS } from './actions'
