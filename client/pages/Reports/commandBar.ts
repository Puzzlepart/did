 ...
 * @param {IReportsContext} context Reports context
 */
const selectGroupByCmd = (context: IReportsContext) => (!!context.query && !context.loading) && ({
  key: 'SELECT_GROUP_BY',
 ...
 * @param {IReportsContext} context Reports context
 */
const openFilterPanel = (context: IReportsContext) => (!!context.query && !context.loading)&& ({
